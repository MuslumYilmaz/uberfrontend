...
export const JAVASCRIPT_MASTERY_PATH: MasteryPath = {
  ...
  items: [
    ...
    },
    {
      ...
      moduleId: 'foundations',
      type: 'trivia',
      title: 'Truthy/falsy + strict equality in real cases',
      summary: 'Use truthy/falsy, pass-by-value/reference, and strict equality together in bug-prone flows.',
      difficulty: 'intermediate',
      estimatedMinutes: 10,
      xp: 12,
      target: triviaTarget('truthy falsy strict equality pass by value reference'),
    },
    {
    ...
    },
    {
      ...
      moduleId: 'objects-prototypes',
      type: 'trivia',
      title: 'Comparing objects correctly',
      summary: 'Choose reference, shallow, or deep comparison by intent and performance constraints.',
      difficulty: 'intermediate',
      estimatedMinutes: 10,
      xp: 14,
      target: triviaTarget('compare two objects javascript'),
    },
    {
    ...
    {
      id: 'js-async-callback-hell-promise-trivia',
      moduleId: 'async-event-loop',
      type: 'trivia',
      title: 'Callback hell resolved with Promise',
      summary: 'Refactor nested callback pyramids into flatter Promise flows with centralized failure handling.',
      difficulty: 'hard',
      estimatedMinutes: 12,
      xp: 16,
      target: triviaTarget('callback hell resolved with promise'),
    },
    {
      id: 'js-async-when-promise-preferred-trivia',
      moduleId: 'async-event-loop',
      type: 'trivia',
      title: 'When Promise is preferred over async/await',
      summary: 'Pick Promise APIs for composition-heavy concurrency and in-flight request sharing.',
      difficulty: 'hard',
      estimatedMinutes: 12,
      xp: 16,
      target: triviaTarget('when promise is preferred over async await'),
    },
    {
    ...
    {
      id: 'js-browser-cookie-options-trivia',
      moduleId: 'browser-practice',
      type: 'trivia',
      title: 'Cookie options and security attributes',
      summary: 'Use Expires/Max-Age, Domain/Path, and Secure/HttpOnly/SameSite with correct security intent.',
      difficulty: 'intermediate',
      estimatedMinutes: 10,
      xp: 12,
      target: triviaTarget('cookie options samesite httponly secure'),
    },
    {
    ...
    },
    {
      ...
      moduleId: 'mastery',
      type: 'trivia',
      title: 'Repaint vs reflow diagnosis',
      summary: 'Differentiate layout and paint costs, then mitigate layout thrashing in real UI traces.',
      difficulty: 'hard',
      estimatedMinutes: 10,
      xp: 14,
      target: triviaTarget('reflow repaint browser rendering'),
    },
    {
