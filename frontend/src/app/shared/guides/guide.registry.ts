...
export const PLAYBOOK: GuideEntry[] = [
        ...
        seo: {
            ...
            itemList: {
                ...
                items: [
                    ...
                    { name: 'Implement Function.prototype.bind', description: 'Tests this binding, partial arguments, new.target detection, and a documented classic-constructor subset.', url: '/javascript/coding/js-implement-bind' },
                    { name: 'Implement the new operator', description: 'Tests constructable targets, classes, bound constructors, prototype fallback, and explicit return values.', url: '/javascript/coding/js-implement-new' },
        ...
        seo: {
            ...
            itemList: {
                ...
                items: [
                    ...
                    { name: 'this / bind / call-site', description: 'Resolve implicit, explicit, constructor, default, and arrow binding with preserved args and a scoped classic-constructor model.', url: '/javascript/coding/js-implement-bind' },
    ...
    },
    {
        ...
        minutes: 18,
        summary: 'Prepare for frontend system design interviews with the round format, question types, evaluation rubric, readiness checklist, practice plan, and realistic prompts.',
        seo: {
            title: 'Frontend System Design Interview Preparation Guide',
            description: 'Prepare for a frontend system design interview with the round format, question types, evaluation rubric, practice plan, and realistic prompts.',
            primaryKeyword: 'frontend system design interview preparation',
            keywords: [
                'frontend system design interview preparation',
            ...
            faqPage: {
                name: 'Frontend system design interview preparation FAQ',
                items: [
                    {
                        question: 'What is a frontend system design interview?',
                        answer: 'A frontend system design interview tests how you scope an ambiguous UI problem, define client architecture and state boundaries, consume APIs, handle user-visible failures, and explain accessibility, performance, and product trade-offs.',
                    },
                    {
                        question: 'How do I prepare for a frontend system design interview?',
                        answer: 'Learn the round format, baseline yourself on a familiar prompt, use a repeatable answer method, practice both application and UI-component questions, score each attempt with a rubric, and repeat timed mocks until your gaps are predictable.',
                    },
                    {
                        question: 'What format does a frontend system design interview use?',
                        answer: 'Most rounds use either a product-scale application prompt or a focused UI-component prompt. Both expect clarifying questions, a clear architecture, concrete state and interface decisions, and defensible trade-offs.',
                    },
                    {
                        question: 'How are application architecture and UI component questions different?',
                        answer: 'Application prompts emphasize page boundaries, rendering, routing, data flow, caching, and cross-feature ownership. UI-component prompts go deeper on component APIs, interaction states, accessibility, async behavior, and performance.',
                    },
                    {
                        question: 'How should I practice frontend system design questions?',
                        answer: 'Rotate through familiar, realtime, data-heavy, and senior architecture prompts. Record assumptions, draw the design, narrate trade-offs, score the result, and repeat the weakest section before attempting another full mock.',
                    },
                    {
                        question: 'How do I know I am ready for a frontend system design interview?',
                        answer: 'You are ready when you can clarify scope quickly, keep one user flow as the thread, draw implementable client boundaries, cover loading and failure states, and explain the highest-risk trade-offs without relying on a memorized solution.',
                    },
                ],
            },
            itemList: {
                name: 'Frontend system design interview preparation plan',
                items: [
                    { name: 'Understand the interview scope', description: 'Separate client-side architecture decisions from backend infrastructure depth.', url: '#frontend-vs-backend-scope' },
                    { name: 'Learn the two question formats', description: 'Recognize product-scale application prompts and focused UI-component prompts.', url: '#frontend-system-design-interview-format' },
                    { name: 'Run a baseline prompt', description: 'Use a familiar notification problem to expose gaps before studying solutions.', url: '/system-design/notification-toast-system' },
                    { name: 'Learn the RADIO method', description: 'Use Requirements, Architecture, Data, Interface, and Optimizations to structure an answer.', url: '/guides/system-design-blueprint/radio-framework' },
                    { name: 'Practice across prompt families', description: 'Rotate through realtime, data-heavy, component, and senior architecture questions.', url: '/system-design' },
                    { name: 'Score a timed mock', description: 'Use the evaluation rubric to find the next preparation gap.', url: '/guides/system-design-blueprint/evaluation' },
                ],
            },
            readerPromise: 'Use this frontend system design interview preparation guide to understand the round, choose the right question format, build a practice plan, and score realistic mock answers.',
            uniqueAngle: 'A frontend-specific preparation sequence that connects interview format, readiness signals, rubric-based review, the RADIO method, and direct practice prompts without duplicating the answer template.',
            publishedAt: '2025-09-28',
...
export const SYSTEM: GuideEntry[] = [
    ...
    },
    {
        ...
        seo: {
            ...
            description: 'Use the RADIO framework for frontend system design with a 45-minute interview script, diagram checklist, and worked autocomplete example.',
            primaryKeyword: 'radio framework',
            keywords: [
                'radio framework',
                'radio framework system design',
                'RADIO framework frontend system design',
                'radio framework template',
                'radio framework example',
                ...
                'radio framework interview questions',
            ...
            readerPromise: 'Use Requirements, Architecture, Data, Interface, and Optimizations to turn an open-ended UI architecture prompt into a clear 45-minute interview answer.',
