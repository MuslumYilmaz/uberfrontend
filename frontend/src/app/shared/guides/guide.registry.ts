        ...
        seo: {
            ...
            itemList: {
                ...
                items: [
                    ...
                    { name: 'Design a toast notification system', description: 'Practice global toast APIs, queueing, focus safety, live regions, dismissal policy, and animation trade-offs.', url: '/system-design/notification-toast-system' },
...
export const SYSTEM: GuideEntry[] = [
    ...
    },
    {
        ...
        seo: {
            title: 'RADIO Framework: Frontend System Design Interview Template',
            description: 'A practical RADIO framework guide for frontend system design interviews with a 45-minute answer script, diagram checklist, and examples.',
            ...
            keywords: [
                ...
                '45-minute frontend system design framework',
                '45-minute frontend system design answer template',
