...
- Inputs: `testId`, `title`, `description`, `descriptionTooltip`, `kindLabel`, `routeLink`, `queryParams`, `state`, `disabled`, `solved`, `lockedLabel`, `companies`, `preferredCompanySlug`, `metaChips`, `variants`
