...
export const TRACKS: TrackConfig[] = [
  ...
  },
  {
    ...
    featured: [
      ...
      { id: 'js-deep-equal', tech: 'javascript', kind: 'coding' },
      { id: 'js-deep-clone', tech: 'javascript', kind: 'coding' },
      { id: 'js-curry-function', tech: 'javascript', kind: 'coding' },

      // UI flows (5 total)
      { id: 'react-debounced-search', tech: 'react', kind: 'coding' },
      { id: 'angular-debounced-search', tech: 'angular', kind: 'coding' },
      { id: 'vue-debounced-search', tech: 'vue', kind: 'coding' },
      ...
      { id: 'js-null-undefined-undeclared', tech: 'javascript', kind: 'trivia' },
      { id: 'js-equality-vs-strict-equality', tech: 'javascript', kind: 'trivia' },
      { id: 'js-hoisting', tech: 'javascript', kind: 'trivia' },
      { id: 'js-higher-order-function', tech: 'javascript', kind: 'trivia' },
      { id: 'js-event-bubbling-capturing', tech: 'javascript', kind: 'trivia' },
      { id: 'html-dom', tech: 'html', kind: 'trivia' },
      { id: 'html-head-tag', tech: 'html', kind: 'trivia' },
      { id: 'html-semantic-elements', tech: 'html', kind: 'trivia' },
      { id: 'html-a-tag', tech: 'html', kind: 'trivia' },
      { id: 'html-title-tag', tech: 'html', kind: 'trivia' },
      { id: 'css-definition', tech: 'css', kind: 'trivia' },
      { id: 'css-inline-internal-external', tech: 'css', kind: 'trivia' },
      { id: 'css-background-color', tech: 'css', kind: 'trivia' },
      { id: 'css-text-color', tech: 'css', kind: 'trivia' },
      { id: 'css-center-text', tech: 'css', kind: 'trivia' },
      { id: 'css-border-property', tech: 'css', kind: 'trivia' },
      { id: 'css-margin-property', tech: 'css', kind: 'trivia' },
      { id: 'css-padding-property', tech: 'css', kind: 'trivia' },
      { id: 'css-font-family', tech: 'css', kind: 'trivia' },
  ...
  },
  {
    ...
    featured: [
      // JavaScript coding fundamentals (breadth for 30 days)
      ...
      // UI fundamentals across frameworks (starter flows)
      ...
      { id: 'vue-todo-list', tech: 'vue', kind: 'coding' },
      { id: 'vue-tabs-switcher', tech: 'vue', kind: 'coding' },
      { id: 'vue-contact-form-starter', tech: 'vue', kind: 'coding' },
      { id: 'vue-accordion-faq', tech: 'vue', kind: 'coding' },

      // HTML/CSS fundamentals (structure, forms, layout)
      { id: 'html-basic-structure', tech: 'html', kind: 'coding' },
      { id: 'html-links-and-images', tech: 'html', kind: 'coding' },
      { id: 'html-lists-and-navigation', tech: 'html', kind: 'coding' },
      { id: 'html-semantic-layout', tech: 'html', kind: 'coding' },
      { id: 'html-contact-form-labeled', tech: 'html', kind: 'coding' },
      { id: 'html-forms-validation-required', tech: 'html', kind: 'coding' },
      { id: 'html-head-seo-basics', tech: 'html', kind: 'coding' },
      { id: 'css-selectors-text-basics', tech: 'css', kind: 'coding' },
      { id: 'css-box-model-margin-padding-border', tech: 'css', kind: 'coding' },
      { id: 'css-inline-centering', tech: 'css', kind: 'coding' },
      ...
      { id: 'css-fluid-clamp', tech: 'css', kind: 'coding' },
      { id: 'css-transitions-transforms-lift', tech: 'css', kind: 'coding' },

      // System design light touch
      { id: 'notification-toast-system', kind: 'system-design' },
      { id: 'image-upload-preview', kind: 'system-design' },
      { id: 'multi-step-form-autosave', kind: 'system-design' },
      { id: 'dashboard-widgets-draggable-resizable', kind: 'system-design' },
      { id: 'component-design-system-architecture', kind: 'system-design' },

      // Trivia (foundational breadth)
      { id: 'js-event-loop', tech: 'javascript', kind: 'trivia' },
      { id: 'js-closures', tech: 'javascript', kind: 'trivia' },
      { id: 'js-this-keyword', tech: 'javascript', kind: 'trivia' },
      { id: 'js-hoisting-tdz', tech: 'javascript', kind: 'trivia' },
      ...
      { id: 'js-cookie-sessionstorage-localstorage', tech: 'javascript', kind: 'trivia' },
      { id: 'js-prototypal-inheritance', tech: 'javascript', kind: 'trivia' },
      { id: 'js-data-types', tech: 'javascript', kind: 'trivia' },
      { id: 'js-foreach-vs-map', tech: 'javascript', kind: 'trivia' },
      { id: 'js-arrow-functions', tech: 'javascript', kind: 'trivia' },
      { id: 'js-object-destructuring', tech: 'javascript', kind: 'trivia' },
      { id: 'js-classes', tech: 'javascript', kind: 'trivia' },
      { id: 'js-deferred-scripts', tech: 'javascript', kind: 'trivia' },
      { id: 'html-dom', tech: 'html', kind: 'trivia' },
      { id: 'html-semantic-elements', tech: 'html', kind: 'trivia' },
      { id: 'html-block-inline-elements', tech: 'html', kind: 'trivia' },
      { id: 'html-a-tag', tech: 'html', kind: 'trivia' },
      { id: 'html-title-tag', tech: 'html', kind: 'trivia' },
      { id: 'html-img-alt-attribute', tech: 'html', kind: 'trivia' },
      { id: 'html-id-vs-class', tech: 'html', kind: 'trivia' },
      { id: 'css-definition', tech: 'css', kind: 'trivia' },
      { id: 'css-box-model', tech: 'css', kind: 'trivia' },
      { id: 'css-specificity-hierarchy', tech: 'css', kind: 'trivia' },
      { id: 'css-display-flex', tech: 'css', kind: 'trivia' },
      { id: 'css-grid-vs-flexbox', tech: 'css', kind: 'trivia' },
      { id: 'css-media-queries', tech: 'css', kind: 'trivia' },
      { id: 'css-units-em-rem-percent-px', tech: 'css', kind: 'trivia' },
      { id: 'css-pseudo-classes-elements', tech: 'css', kind: 'trivia' },
    ],
  },
];
