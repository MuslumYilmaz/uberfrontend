...
const criticalRouteContracts = [
  ...
  },
  {
    ...
    title: 'JavaScript Interview Questions: 41 Q&A',
  ...
  },
  {
    ...
    title: 'Vue.js Interview Questions: 65 Q&A',
  ...
  },
  {
    ...
    title: 'HTML and CSS Interview Questions: 65 Q&A',
  ...
  },
  {
    ...
    h1: 'RADIO Framework for Frontend System Design Interviews',
    descriptionTerms: ['Requirements', 'Architecture', 'Data', 'Interface', 'Optimizations', '45-minute script'],
    bodyTerms: [
      'Use this if your interviewer asks',
      'How would you design X?',
      'Copyable 45-minute answer structure',
      'Turn a broad prompt into a 45-minute frontend system design interview answer',
