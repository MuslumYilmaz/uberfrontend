...
- Treat spacing, wrapping, and responsive reflow as trust-critical UI behavior. User-facing layouts must keep readable line lengths and avoid clipped, overflowing, or word-by-word text on both mobile and desktop.
